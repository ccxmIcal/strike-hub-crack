...
function lib:Window(text, preset, closebind)
    ...
    Title.Text = 'cracked by sufi#1337 || discord.gg/seere'
    ...
    HiText.Text = "Welcome, " .. game.Players.LocalPlayer.Name
    ...
    task.wait(0.3)
    HiText.Text = "cracked by sufi#1337 || discord.gg/seere"
    task.wait(0.1)
    TweenService:Create(HiText, TweenInfo.new(0.3), { TextTransparency = 0 }):Play()
    wait(1)
    TweenService:Create(HiText, TweenInfo.new(0.3), { TextTransparency = 1 }):Play()
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:Textbox(text, disapper, callback)
            ...
            Box.BackgroundColor3 = Color3.fromRGB(37, 37, 37)
